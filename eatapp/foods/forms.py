...
class AddFood(FlaskForm):
    ...
    price = IntegerField('Price', validators=[DataRequired()])          # price field
    ...
    image = FileField('image', validators=[FileRequired(),FileAllowed(['jpg','jpeg','png','gif'], 'images only!')])     # image field